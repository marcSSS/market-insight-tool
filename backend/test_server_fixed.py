...
async def root():
    """健康检查端点"""
    return {"message": "北美市场洞察工具 API - 测试版", "status": "running"}
...
async def get_analysis_result(task_id: str):
    ...
    if task_info["status"] == "completed":
        ...
        print(f"DEBUG: Analyzing URL: {url}")  # 调试信息
        
        if "apple" in url:
            print("DEBUG: Generating Apple analysis")  # 调试信息
            result = generate_apple_analysis()
        elif "microsoft" in url:
            print("DEBUG: Generating Microsoft analysis")  # 调试信息
            result = generate_microsoft_analysis()
        elif "amazon" in url:
            print("DEBUG: Generating Amazon analysis")  # 调试信息
            result = generate_amazon_analysis()
        else:
            print("DEBUG: Generating generic analysis")  # 调试信息
